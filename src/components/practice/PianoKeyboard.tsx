    ...
    <div className="card p-6">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start">
          ...
          <div className="relative mt-6 flex h-40 select-none">
            {whiteKeys.map((note) => (
              <button
                ...
                className={`flex-1 border border-stroke bg-white text-xs font-semibold transition ${
        ...
        <div className="w-full space-y-4 lg:w-72">
            ...
            <div className="mt-4 grid gap-2">
              {Object.keys(chordLibrary).map((chord) => (
                <button
                  ...
                  className="rounded-full border border-stroke bg-white px-4 py-2 text-xs font-semibold text-ink transition hover:border-brand-indigo"
                >
                  {chord}
                </button>
              ))}
          ...
          <div className="rounded-2xl bg-gradient-to-br from-brand-indigo/10 via-brand-purple/10 to-brand-amber/10 p-4 text-xs text-ink-muted">
