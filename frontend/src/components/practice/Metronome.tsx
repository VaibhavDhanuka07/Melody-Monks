  ...
  return (
    <div className="card p-6">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <p className="text-sm font-semibold text-brand-gold-soft">Metronome</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="rounded-full border border-stroke bg-black/50 px-4 py-2 text-sm font-semibold text-ink">
            {bpm} BPM
          </span>
        </div>
      </div>
            ...
            <div
              ...
              className={`h-4 w-4 rounded-full transition ${
                beat === index && isRunning
                  ? "bg-brand-gold-soft shadow-soft"
                  : "bg-ink/10"
              }`}
            ></div>
          ))}
