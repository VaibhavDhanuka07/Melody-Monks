...
export default function LessonPage({
  ...
  const lesson = findLessonBySlug(params.slug);
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between border-b border-white/10 px-6 py-4">
              <div>
                ...
                <p className="mt-2 text-sm text-ink-muted">
                  Module: {lesson.module} | {lesson.duration}
                </p>
              </div>
          ...
          <div className="card-strong p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm text-ink-muted">
              <li>- Warmup: Five-finger pattern in C major</li>
              <li>- Technique: Slow hands-together coordination</li>
              <li>- Repertoire: 8 bars of the lesson piece</li>
            </ul>
          </div>
        </div>
        ...
        <aside className="space-y-6">
          ...
          <div className="card-strong p-6">
            ...
            <p className="mt-3 text-sm text-ink-muted">
              Download the sheet music and keep your practice tracker updated.
            </p>
